...
public class YearPlanAdapter extends SwipeMenuAdapter<BaseViewHolder> {

    private Context mContext;
    private List<YearPlanBean> mDatas;

    public YearPlanAdapter(Context mContext, List<YearPlanBean> mDatas) {
