...
public class WeekyPlanAdapter extends SwipeMenuAdapter<BaseViewHolder> {

    private Context mContext;
    private List<WeekPlanBean> mDatas;

    public WeekyPlanAdapter(Context mContext, List<WeekPlanBean> mDatas) {
