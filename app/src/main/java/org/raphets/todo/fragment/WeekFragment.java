...
import org.raphets.todo.adapter.WeekyPlanAdapter;
...
public class WeekFragment extends BaseFragment {
    ...
    private WeekyPlanAdapter mAdapter;
    private List<WeekPlanBean> mDatas=new ArrayList<>();
    ...
    private void getData() {
        List<WeekPlanBean> datas= RealmHelper.queryWeekPlan();
        mDatas.clear();
        mDatas.addAll(datas);
    ...
    private void initRecyclerView() {
        ...
        mAdapter=new WeekyPlanAdapter(getActivity(),mDatas);
        recyclerView.setAdapter(mAdapter);

        tvEmpty.setText("主人，这周还没有计划呢");
    }
    ...
    private void addListener() {
        ...
        recyclerView.setSwipeMenuItemClickListener(new OnSwipeMenuItemClickListener() {
            ...
            public void onItemClick(Closeable closeable, int adapterPosition, int menuPosition, int direction) {
                RealmHelper.delWeekPlan(adapterPosition);
