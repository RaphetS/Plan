...
import org.raphets.todo.adapter.YearPlanAdapter;
...
public class YearFragment extends BaseFragment {
    ...
    private List<YearPlanBean> mDatas=new ArrayList<>();
    ...
    private void getData() {
        List<YearPlanBean> datas= RealmHelper.queryYearPlan();
        mDatas.clear();
        mDatas.addAll(datas);
    ...
    private void initRecyclerView() {
        ...
        mAdapter=new YearPlanAdapter(getActivity(),mDatas);
        recyclerView.setAdapter(mAdapter);

        tvEmpty.setText("主人，今年还没有计划呢");
    }
    ...
    private void addListener() {
        ...
        recyclerView.setSwipeMenuItemClickListener(new OnSwipeMenuItemClickListener() {
            ...
            public void onItemClick(Closeable closeable, int adapterPosition, int menuPosition, int direction) {
                RealmHelper.delYearPlan(adapterPosition);
